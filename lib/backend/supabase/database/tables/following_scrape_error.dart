...
class FollowingScrapeErrorTable extends SupabaseTable<FollowingScrapeErrorRow> {
  @override
  String get tableName => 'following_scrape_error';

  @override
  FollowingScrapeErrorRow createRow(Map<String, dynamic> data) =>
      FollowingScrapeErrorRow(data);
}

class FollowingScrapeErrorRow extends SupabaseDataRow {
  FollowingScrapeErrorRow(super.data);

  @override
  SupabaseTable get table => FollowingScrapeErrorTable();
